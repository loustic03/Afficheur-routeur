...
## 3.0 - 2026-03-31  
Version V3.09  
- Ajout réglage du temps avant mise en vielle de l'afficheur entre 1 min et 15 min
...
## 4.0 - 2026-04-20  
Version V4.01  
- Possibilité d'inverser la ligne d'affichage 2 & 4, depuis la page paramètres champ Labels d'affichage écran (demande d'un utilisateur)
